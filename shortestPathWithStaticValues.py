...
def print_graph(graph):
    """Grafı daha okunabilir bir formatta ekrana yazdırır."""
...
def main():
    ...
    if constraints['bandwidth'] != 5:
        print("Bandwidth demand must be 5.")
        return

    if constraints['delay'] > 40:
        print("Delay threshold must be less than 40.")
        return

    if constraints['reliability'] < 0.70:
        print("Reliability threshold must be greater than 0.7.")
        return
